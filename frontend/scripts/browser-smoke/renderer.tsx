...
import { exercisePopupNavigation } from './popups'
...
function Fixture() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      stage = 'annotation after renderer updates and composer delivery'
      ...
      await exerciseProfileImport(browser)
      stage = 'new-tab link handoff'
      await exercisePopupNavigation(browser, evaluate)
