...
export function VoiceOverlay() {
  ...
  return <div className="grid h-full place-items-center p-3"><FloatingVoice voice={voice} level={state.level} outputLevel={state.outputLevel} onReturn={() => command('return')} /></div>
}
